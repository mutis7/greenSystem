                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form class="form-horizontal" role="form" method="POST" action="{{ url('houses/'.$house->id) }}" >
                                    {{csrf_field() }}
                                    {{ method_field('PUT') }}
                                    <div class="row">
                                        <div class="col-md-7">
                                            <div class="form-group {{ $errors->has('county_id') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control" id="county">
                                                    <option selected="selected" value="{{$countyId}}"> {{ $countyName}}</option>
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group {{ $errors->has('location_id') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control" id="location" name="location_id">
                                                    <option selected="selected" value="{{ $locationId}}"> {{$locationName}}</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <div class="form-group {{ $errors->has('house') ? ' has-error' : '' }}">
                                                ...
                                                <input id="house" type="text" class="form-control" name="house" value="{{ $house->house }}" required autofocus>
                                                @if ($errors->has('house'))
