        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('vehicles/'.$vehicle->id) }}">  
                     {{ csrf_field() }} 
                     {{ method_field('PUT') }}
                     ...
                     <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="type" value="{{ $vehicle->type }}" required autofocus>
                                @if ($errors->has('type'))
                        ...
                        <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="status" type="text" class="form-control" name="status" value="{{ $vehicle->status }}" required autofocus>
